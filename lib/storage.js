...
const DEFAULT_USER_CONTEXT = {
  ...
  dietary: [],
  api_key: ''              // Separate storage usually, but keeping structure clean
};
...
export async function getUserContext() {
  try {
    ...
    // Merge deep to ensure new fields (like sweeteners) exist even for old users
    return { ...DEFAULT_USER_CONTEXT, ...stored, preferences: { ...DEFAULT_USER_CONTEXT.preferences, ...stored.preferences }, sweeteners: { ...DEFAULT_USER_CONTEXT.sweeteners, ...stored.sweeteners } };
  } catch (error) {
